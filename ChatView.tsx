...
const ChatMessage: React.FC<{
  ...
  const { msg, t, onRegenerate, onDelete, onOpenModal, onSetProjectContext, onOpenSourcesModal, onOpenThinkingModal, onStartEdit, onMessageFeedback, onReportMessage, isDesktop, onOpenStreamingProjectView, onAskWithSelection } = props;
      ...
      >
        ...
        {!msg.isStreaming && (
            <div className="flex items-center justify-between">
              <AiMessageFooter msg={msg} t={t} onOpenSourcesModal={onOpenSourcesModal} onOpenThinkingModal={onOpenThinkingModal} />
