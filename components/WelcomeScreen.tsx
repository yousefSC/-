...
const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ onQuestionClick, t }) => {
    ...
    <div className="flex flex-col h-full text-center p-4">
      <div className="flex-1 flex flex-col justify-center items-center">
        <div className="flex items-center justify-center pb-8">
            <h2 className="text-4xl font-extrabold tracking-wider text-slate-300 dark:text-neutral-800 font-brand pressable-text">
                NANOM AI STUDIO
            </h2>
        </div>
      </div>
